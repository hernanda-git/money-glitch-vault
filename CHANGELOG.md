...
## 2026-07-07 -- enrich: warung micro-fulfillment bottleneck -- 26K-char bottleneck analysis of why Indonesia's ~16-21M warungs (dense physical retail leaf nodes of 64M UMKM) are not yet logistics nodes; covers failed prior attempts (Mitra Bukalapak, Warung Pintar/Yummy-Grab, Shopee Mitra, GoFood, seleraku), a reference architecture (node schema, capacity sync, geohash dispatch, QRIS settlement), unit economics, and 3 new gaps
